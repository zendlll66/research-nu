...
export default function Example() {
  ...
  return (
    <div className="relative bg-white min-h-screen flex flex-col overflow-x-auto">
      ...
      <div className="absolute inset-0 -z-10 bg-orange-500" aria-hidden="true" />
      ...
      <div className="flex-grow">
        ...
        <div className="relative isolate px-6 lg:px-8">
          <div aria-hidden="true" className="fixed inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-xl sm:-top-80">
            <div
              style={{
          ...
          <div aria-hidden="true" className="fixed inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-xl sm:top-[calc(100%-30rem)]">
            <div
              style={{
                clipPath: 'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
              }}

      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-center space-x-4  p-4">
          ...
          <div className="mb-4 md:mb-0 font-light p-4">
            ...
            <p className="text-sm max-w-[400px] indent-5 mb-2">สำนักงานเลขานุการคณะวิศวกรรมศาสตร์ มหาวิทยาลัยนเรศวร99 หมู่ 9 ถนนพิษณุโลก-นครสวรรค์ ตำบลท่าโพธิ์ อำเภอเมือง จังหวัดพิษณุโลก 65000</p>

            <div className='flex items-center gap-2'>
              <IoCall />
              <p>0-5596-3961 (Public relations unit)</p>
            </div>
            <div className='flex items-center gap-2'>
              <IoCall />
              <p>0-5596-4018 (Student Affairs Unit)</p>
            </div>
            <div className='flex items-center gap-2'>
              <IoCall />
              <p>0-5596-4009 (Academic unit)</p>
            </div>
            <div className='flex items-center gap-2'>
              <FaFax />
              <p>FAX : 0-5596-4000</p>
          ...
          <div className="flex flex-col  p-4">
            ...
            <div className='flex items-center gap-2'>
              <FiInstagram />
              <a href="#" className="hover:text-orange-400">IG</a>
            </div>
          </div>
